...
public class ViveControllerInput2 : MonoBehaviour {
    private SteamVR_TrackedObject trackedObj;
    private SpeedControl2 speedControlObj;
    ...
    private void Awake()
    {
        ...
        speedControlObj = FindObjectOfType<SpeedControl2>().GetComponent<SpeedControl2>();
        touchPadDown = false;
    }
